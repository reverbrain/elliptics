...
#define DNET_MONITOR_CACHE			(1<<0)				/* Category for cache statistics */
#define DNET_MONITOR_IO				(1<<1)				/* Category for IO queue statistics */
#define DNET_MONITOR_COMMANDS		(1<<2)				/* Category for commands statistics */
#define DNET_MONITOR_IO_HISTOGRAMS	(1<<3)				/* Category for IO hisograms statistics */
#define DNET_MONITOR_BACKEND		(1<<4)				/* Category for backend statistics */
#define DNET_MONITOR_CALL_TREE		(1<<5)				/* Category for call tree generated by react */
#define DNET_MONITOR_ALL			(-1)				/* Category for requesting all available statistics */
